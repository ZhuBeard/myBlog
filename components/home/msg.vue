<template>
  <div class="msgCenter">
    <div class="figure-pop-main">
      ...
      <ul ref="msgUl" class="msgBox" v-else>
        <li>1123</li>
        <li>123</li>
        <li>123</li>
        <li>123</li>
    ...
    <span @click="toggleShow" class="putButton" v-if="user">留言</span>
    <div @mouseDown="handleMouseDown" class="msgInput" v-else>
...
import Pop from '@/components/windo'
...
.bubble {
  ...
  &::before {
    content: url('http://cdn.toofook.com/my-blog/bubble.png');
  }
}
.showMsg {
  opacity: 0;
  transform: translateY(40px);
  animation: msgUl 0.3s ease-out forwards;
}
...
.msgTitle {
  ...
  .msgLight {
    ...
    a {
      ...
      float: left;
      margin-top: -4px;
      background: url('http://cdn.toofook.com/my-blog/light.png') no-repeat
        center;
    }
  }
}
